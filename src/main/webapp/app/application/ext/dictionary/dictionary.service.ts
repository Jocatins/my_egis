...
export class DictionaryService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/dictionaries';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDictionary[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
