...
import { SurveyorComponent } from 'app/entities/surveyor/surveyor.component';
...
describe('Component Tests', () => {
  describe('Surveyor Management Component', () => {
    let comp: SurveyorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SurveyorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.surveyors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
